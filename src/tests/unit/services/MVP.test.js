...
const { 
  ...
  updateOrder,
  updateProductOrder
} = require('../../../services/MVP');


describe('Testando o arquivo Services/MVP da função createOrder', () => {
  afterEach(() => {
    sinon.restore();
  })
...
describe('Testando o arquivo Services/MVP da função getOrders', () => {
  afterEach(() => {
    sinon.restore();
  });
...
describe('Testando o arquivo Services/MVP da função deleteOrder', () => {
  afterEach(() => {
    sinon.restore();
  });
...
describe('Testando o arquivo Services/MVP da função deleteProductOrder', () => {
  afterEach(() => {
    sinon.restore();
  });
...
describe('Testando o arquivo Services/MVP da função updateOrder', () => {
  afterEach(() => {
    sinon.restore();
  });
...
describe('Testando o arquivo Services/MVP da função updateProductOrder', () => {
  afterEach(() => {
    sinon.restore();
  });
